...
export default function Resume() {
  const handleDownloadResume = () => {
    ...
    const summary =
      "Full Stack Developer with 3+ years of experience in designing and developing scalable, high-performance software solutions and resilient systems for enterprise banking platforms.";
    doc.setFontSize(10);
    doc
      .splitTextToSize(summary, pageWidth - rightX - margin)
    ...
    doc.setFontSize(12);
    doc.setTextColor(...purple);
    doc.text("Portfolio & Links", rightX, yRight);
    yRight += 6;
    ...
    // Portfolio
    doc.text("Portfolio:", rightX, yRight);
    doc.setTextColor(...purple);
    doc.textWithLink("Sathya - Portfolio", rightX + 18, yRight, {
      url: "https://sathyaprabhakara.github.io/sathya-portfolio",
    });
    yRight += 6;

    // LinkedIn
    doc.setTextColor(0, 0, 0);
    doc.text("LinkedIn:", rightX, yRight);
    doc.setTextColor(...purple);
    doc.textWithLink("Sathya - LinkedIn", rightX + 18, yRight, {
      url: "https://www.linkedin.com/in/sathyaprabhakara/",
    });
    yRight += 6;
      ...
      <div className="resume-content">
        <div className="resume-left-column">
          <div className="resume-section">
            <h3 className="resume-section-title purple-title">
              Contact Information
            </h3>
        ...
        <div className="resume-right-column">
          <div className="resume-header">
            ...
            <p className="resume-summary">
              Focused on building scalable, high-performance software solutions
              and resilient systems that drive real business impact in the
              banking industry.
            </p>
          </div>
          ...
          <div className="resume-section">
            ...
            <p className="resume-intro">
              I've worked on several web projects over the past 3+ years, some
            ...
            <div className="resume-experience">
              <div className="experience-item">
                ...
                <p className="company-description">
                  Developing cybersecurity and compliance management systems for
                ...
                <div className="project">
                  ...
                  <ul>
                    <li>
                      Designed and built a centralized platform to ingest,
                      classify, and remediate cybersecurity anomalies across
                      multiple security controls, providing end-to-end
                      visibility and lifecycle tracking.
                    </li>
                    <li>
                      Implemented a metadata-driven, low-code workflow engine
                      using a deterministic finite state machine (FSM), enabling
                      rapid onboarding of new security processes without code
                      changes.
                    </li>
                    <li>
                      Engineered scalable ingestion and enrichment pipelines
                      (push/pull, validation, staging, caching) to normalize
                      high-volume security events and link them to people,
                      applications, and infrastructure.
                    </li>
                    <li>
                      Built a type-safe runtime and integration layer supporting
                      dynamic rule evaluation (SpEL), asynchronous messaging
                      (RabbitMQ), and REST-based coordination with external
                      security systems.
                    </li>
                    <li>
                      Deployed and operated the platform on Kubernetes,
                      establishing CI/CD with Jenkins and Docker, and improving
                      reliability and observability using Elastic/Kibana and
                      centralized monitoring.
                    </li>
                    <li>
                      Improved code quality and delivery velocity by leveraging
                      AI-assisted development tools (GitHub Copilot),
                      implementing automated testing (JUnit, FitNesse, Cypress),
                      and enforcing static analysis and quality gates via
                      SonarQube.
                    </li>
                  </ul>
                </div>
                ...
                <div className="project">
                  ...
                  <ul>
                    <li>
                      Built a distributed, microservices-based platform to
                      monitor operational risk indicators in near real time,
                      enabling early detection of risk escalation across
                      large-scale enterprise systems.
                    </li>
                    <li>
                      Designed and implemented backend services using Java,
                      Spring Boot, PostgreSQL, and MyBatis, supporting
                      high-throughput data processing, batch jobs, and complex
                      aggregation workflows.
                    </li>
                    <li>
                      Deployed and operated services on Kubernetes, improving
                      system availability, scalability, and fault isolation
                      across multiple environments.
                    </li>
                    <li>
                      Developed REST APIs and React-based UI to manage
                      end-to-end lifecycle of risk metrics, including
                      template-driven creation, bulk updates, and entity-level
                      instantiation.
                    </li>
                    <li>
                      Strengthened system reliability, security, and
                      observability through OAuth2-based authentication
                      (ForgeRock), ELK/APM monitoring, optimized connection
                      pooling (HikariCP), and object storage integration (S3).
                    </li>
                  </ul>
                </div>
              </div>
